...
## 2026-03-12 - WP1.5 remediation B runtime parity checker
- Added deterministic runtime checker module: `hrl_trainer.v5.tools.runtime_parity_check`.
- Added wrapper script for reproducible manual/auto parity execution:
  - `scripts/v5/run_wp1_5_runtime_parity_check.sh`
- Added docs:
