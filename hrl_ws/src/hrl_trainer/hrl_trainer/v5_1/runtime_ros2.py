...
class GazeboTargetVisualizer:
    ...
    def _build_marker_sdf(self, pose6: np.ndarray) -> str:
        ...
        return (
            ...
            "<geometry><sphere><radius>0.070</radius></sphere></geometry>"
            "<material><ambient>0.02 1.00 0.18 1.00</ambient><diffuse>0.02 1.00 0.18 1.00</diffuse><emissive>0.02 0.60 0.10 1.00</emissive></material>"
            "</visual>"
            "<visual name='target_box'>"
            "<geometry><box><size>0.300 0.300 0.100</size></box></geometry>"
            "<material><ambient>0.05 0.75 1.00 0.45</ambient><diffuse>0.05 0.75 1.00 0.45</diffuse><emissive>0.00 0.20 0.35 0.45</emissive></material>"
            "</visual>"
            "<visual name='axis_x'>"
            "<pose>0.175 0.000 0.000 0 0 0</pose>"
            "<geometry><box><size>0.350 0.028 0.028</size></box></geometry>"
            "<material><ambient>1.00 0.05 0.05 1.00</ambient><diffuse>1.00 0.05 0.05 1.00</diffuse><emissive>0.45 0.02 0.02 1.00</emissive></material>"
            "</visual>"
            "<visual name='axis_y'>"
            "<pose>0.000 0.175 0.000 0 0 0</pose>"
            "<geometry><box><size>0.028 0.350 0.028</size></box></geometry>"
            "<material><ambient>0.02 1.00 0.10 1.00</ambient><diffuse>0.02 1.00 0.10 1.00</diffuse><emissive>0.02 0.45 0.05 1.00</emissive></material>"
            "</visual>"
            "<visual name='axis_z'>"
            "<pose>0.000 0.000 0.175 0 0 0</pose>"
            "<geometry><box><size>0.028 0.028 0.350</size></box></geometry>"
            "<material><ambient>0.10 0.30 1.00 1.00</ambient><diffuse>0.10 0.30 1.00 1.00</diffuse><emissive>0.04 0.12 0.45 1.00</emissive></material>"
            "</visual>"
            "</link>"
            "</model>"
            "</sdf>"
