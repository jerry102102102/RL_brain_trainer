# Training Report: main_reward_phasea_v2_entropy_event_s0b_tc0_act008_001

## Headline
- Episodes completed: 70
- Train success rate: 0.057
- Best min dpos: 0.0075
- Mean final dpos: 0.1296
...
## Gap Diagnosis
- deterministic: success=0.200, basin=0.200, inner=0.000, dwell=0.000, final_dpos=0.0985, action_l2=0.0034, raw_norm=0.0426
- noise010: success=0.200, basin=0.200, inner=0.000, dwell=0.000, final_dpos=0.1070, action_l2=0.0183, raw_norm=0.2292
- noise030: success=0.200, basin=0.600, inner=0.000, dwell=0.000, final_dpos=0.1384, action_l2=0.0535, raw_norm=0.6685
- noise060: success=0.200, basin=0.200, inner=0.000, dwell=0.000, final_dpos=0.1668, action_l2=0.0874, raw_norm=1.0931

## Entropy Annealing
- Mode: event
- Current stage: C
- Current target entropy: -3.500
- Stage switches: 2
- ep20: A->B, target=-4.900, reason=event_train_basin=0.450_inner=0.100_reject=0.025
- ep25: B->C, target=-3.500, reason=event_det_outer_or_basin=0.200/0.200
